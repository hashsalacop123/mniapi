...
class CreateNrMniData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nr_mni_datas', function (Blueprint $table) {
            ...
            $table->bigInteger('callcount')->unsigned()->default(1);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('nr_mni_data');
    }
}
